...
namespace BotX.Api.HttpClients
{
    ...
    {
        public Task<FileMetadataResult> UploadFileAsync(Guid botId, Guid chatId, string fileName, byte[] data, string mimeType, FileMetaInfo meta);
        ...
        public Task SendSmartAppEventAsync(Guid botId, SmartAppEventMessage message);

        public Task SendSmartAppInternalAsync(Guid botId, SmartAppInternalNotificationPayload message);
