...
/**
 * Представляет элемент "Мобильные конвейеры".
 */
export class MobileConveyorsConfiguration extends ElementConfigurationBase {
    /**
    ...
    constructor(
        ...
        super(MobileConveyorsConfiguration.lastVersion, elementId, ElementTypes.MobileConveyors, displayName);
    }
}
